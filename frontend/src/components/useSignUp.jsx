...
const useSignUp = () => {
  ...
  // moved the handleSubmit logic here to handle all of the AWS functionality out of the page
  const handleSubmit = async () => {
    setIsSubmitting(true);
    {/* Determines whether the password has an outstanding confirmation request */}
    if (!isConfirmed) {
      {/* Ensures the password and confirm passwords match and then sends data tries to sign up with AWS */}
      ...
      {/* Send an inputted confirmation code to AWS to finalize account creation */}
      try {
